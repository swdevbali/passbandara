...
Public Class rptPassBulanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TransaksiModule.rptPassBulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPassBulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPassBulanan = New rptPassBulanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
