      ...
      ByVal inContext As IntPtr) As Long
        ...
        Select Case inEvent
            Case kEdsObjectEvent_DirItemRequestTransfer
                CameraControlDlg.controller.actionPerformed("download", inRef)
    ...
    Public Shared Function handlePropertyEvent( _
        ...
        Select Case inEvent
            Case kEdsPropertyEvent_PropertyChanged
                CameraControlDlg.controller.actionPerformed("get", inPropertyID)
            Case kEdsPropertyEvent_PropertyDescChanged
                CameraControlDlg.controller.actionPerformed("getlist", inPropertyID)
        End Select
    ...
    Public Shared Function handleStateEvent( _
        ...
        Select Case inEvent
            Case kEdsStateEvent_Shutdown
                CameraControlDlg.controller.actionPerformed("clse")
