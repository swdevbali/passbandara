...
Public Class HomePersetujuanPage
    ...
    Private Sub HomePersetujuanPage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        cboLvStyle.SelectedIndex = 3
    End Sub
    Public Overrides Sub OnEnterView()
        Button3.Visible = False
        MyBase.OnEnterView()
        If Session.kodeRole = 9 Then Button3.Visible = True
        If Session.kodeRole = 10 Then Button3.Visible = True
        If Session.kodeRole = 23 Then Button3.Visible = True
    End Sub
