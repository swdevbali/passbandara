...
Public Class JenisBerkasListPage
    Inherits PageListTemplate

    Public Sub New()
        InitializeComponent()
        MyBase.PROCEDURE_MASTER = "proc_jenisberkas"
        MyBase.PROCEDURE_SEARCH = "proc_searchall"
        MyBase.SELECT_PARAMETER = New Object() {"select", Nothing, Nothing, Nothing}
        MyBase.FORM_ENTRY_NAME = "JenisBerkasEntryPage"
        defaultAllColumn("tb_jenisberkas")
    End Sub
    Public Overrides Sub prepareSearchParameter(ByVal namakolom As String, ByVal katakunci As String)
        SEARCH_PARAMETER = New Object() {"idtb_jenisberkas as ID,jenis_berkas", "tb_jenisberkas", namakolom, katakunci}
    End Sub
    ...
    Private Sub JenisBerkasListPage_EnterReportPage(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.EnterReportPage
