...
Public Class InstansiListPage
    Inherits PageListTemplate
    Public Sub New()
        InitializeComponent()
        MyBase.PROCEDURE_MASTER = "proc_instansi"
        ...
        MyBase.FORM_ENTRY_NAME = "instansiEntryPage"
        defaultAllColumn("tb_instansi")
    End Sub
    Public Overrides Sub prepareSearchParameter(ByVal namakolom As String, ByVal katakunci As String)
        SEARCH_PARAMETER = New Object() {"idtb_instansi as ID, nama_instansi as `Nama Instansi`, Alamat, maks_kuota as `Kuota Maksimal`", "tb_instansi", namakolom, katakunci}
    End Sub
